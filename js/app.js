(function () {
  ...
  function viewLanding() {
    ...
    return `
      <section class="landing">
        ...
        <p class="by-line">A tool by <a href="https://www.linkedin.com/in/tapasvi-dudhrejiya/" target="_blank" rel="noopener">Mitali Kasodariya</a> · <a href="mailto:mitali.kasodariya163@gmail.com">mitali.kasodariya163@gmail.com</a></p>
        <div class="ways">
  ...
  function buildReport(c) {
    ...
    $('#report').innerHTML = `
      ...
      <p class="meta">Live version ${esc(c.version)}. Decoded ${esc(new Date(c.fetchedAt).toLocaleString())} with TagScope Decoder by Mitali Kasodariya (mitali.kasodariya163@gmail.com). Names are generated from each item's settings.</p>
      <h2>Summary</h2>
      <table><tbody>
